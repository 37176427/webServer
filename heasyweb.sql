/*
 ...
 Source Schema         : heasyweb

 Target Server Type    : MySQL
 Target Server Version : 50724
 File Encoding         : 65001

 Date: 11/12/2019 17:05:17
*/
...
-- ----------------------------
INSERT INTO `oauth_token` VALUES (9, 'eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxIiwiZXhwIjoxNTc2MTQxMzI0fQ.8XdPcU79Pm8SEj_u8ekNEqCoSY0CP2bi_70AuMRxYfo', '1', '[\"delete:/v1/role/{id}\",\"get:/v1/menu\",\"post:/v1/menu\",\"put:/v1/menu\",\"delete:/v1/user/{id}\",\"delete:/v1/menu/{id}\",\"get:/v1/user\",\"get:/v1/user/info\",\"post:/v1/user/login\",\"get:/v1/user/menu\",\"delete:/v1/authorities/role\",\"put:/v1/user/state\",\"post:/v1/authorities/sync\",\"get:/v1/role\",\"get:/v1/authorities\",\"post:/v1/role\",\"post:/v1/user\",\"put:/v1/role\",\"put:/v1/user\",\"put:/v1/user/psw\",\"put:/v1/user/psw/{id}\",\"post:/v1/authorities/role\",\"get:/v1/file\",\"post:/v1/file\"]', '[\"1\"]', NULL, '2019-12-12 17:02:05', '2019-12-11 17:02:05', '2019-12-11 17:02:05');
INSERT INTO `oauth_token` VALUES (10, 'eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxIiwiZXhwIjoxNTc2MTQxNDI4fQ.-f39e2XUtIhOrHKsul1Q3Cvf2nXuQnJOb33mK-Tzbck', '1', '[\"delete:/v1/role/{id}\",\"get:/v1/menu\",\"post:/v1/menu\",\"put:/v1/menu\",\"delete:/v1/user/{id}\",\"delete:/v1/menu/{id}\",\"get:/v1/user\",\"get:/v1/user/info\",\"post:/v1/user/login\",\"get:/v1/user/menu\",\"delete:/v1/authorities/role\",\"put:/v1/user/state\",\"post:/v1/authorities/sync\",\"get:/v1/role\",\"get:/v1/authorities\",\"post:/v1/role\",\"post:/v1/user\",\"put:/v1/role\",\"put:/v1/user\",\"put:/v1/user/psw\",\"put:/v1/user/psw/{id}\",\"post:/v1/authorities/role\",\"get:/v1/file\",\"post:/v1/file\"]', '[\"1\"]', NULL, '2019-12-12 17:03:48', '2019-12-11 17:03:48', '2019-12-11 17:03:48');
INSERT INTO `oauth_token` VALUES (11, 'eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIzIiwiZXhwIjoxNTc2MTQxNDQ1fQ.0bG0GW7OCIkuDZLypqOfaElckAC_-_5IElbeUySiNzw', '3', '[\"delete:/v1/role/{id}\",\"get:/v1/menu\",\"post:/v1/menu\",\"put:/v1/menu\",\"delete:/v1/user/{id}\",\"delete:/v1/menu/{id}\",\"get:/v1/user\",\"get:/v1/user/info\",\"post:/v1/user/login\",\"get:/v1/user/menu\",\"delete:/v1/authorities/role\",\"put:/v1/user/state\",\"post:/v1/authorities/sync\",\"get:/v1/role\",\"get:/v1/authorities\",\"post:/v1/role\",\"post:/v1/user\",\"put:/v1/role\",\"put:/v1/user\",\"put:/v1/user/psw\",\"put:/v1/user/psw/{id}\",\"post:/v1/authorities/role\",\"get:/v1/file\",\"post:/v1/file\"]', '[\"1\"]', NULL, '2019-12-12 17:04:06', '2019-12-11 17:04:05', '2019-12-11 17:04:05');
INSERT INTO `oauth_token` VALUES (12, 'eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxIiwiZXhwIjoxNTc2MTQxNDgxfQ.AFDvpIRZFkvWp4IgOR7LqBIAjLf3lp5KsvCt2vdOFGQ', '1', '[\"delete:/v1/role/{id}\",\"get:/v1/menu\",\"post:/v1/menu\",\"put:/v1/menu\",\"delete:/v1/user/{id}\",\"delete:/v1/menu/{id}\",\"get:/v1/user\",\"get:/v1/user/info\",\"post:/v1/user/login\",\"get:/v1/user/menu\",\"delete:/v1/authorities/role\",\"put:/v1/user/state\",\"post:/v1/authorities/sync\",\"get:/v1/role\",\"get:/v1/authorities\",\"post:/v1/role\",\"post:/v1/user\",\"put:/v1/role\",\"put:/v1/user\",\"put:/v1/user/psw\",\"put:/v1/user/psw/{id}\",\"post:/v1/authorities/role\",\"get:/v1/file\",\"post:/v1/file\"]', '[\"1\"]', NULL, '2019-12-12 17:04:41', '2019-12-11 17:04:41', '2019-12-11 17:04:41');
...
-- ----------------------------
INSERT INTO `oauth_token_key` VALUES (1, '0d870b80f498f7efbdd3faf489c192dfa926a5ff466f371fa1c953d4cd1bf7c5', '2019-12-04 14:46:31');
...
-- ----------------------------
INSERT INTO `sys_authorities` VALUES ('delete:/v1/authorities/role', '移除角色权限', '权限管理', 3, '2019-12-06 17:37:16');
INSERT INTO `sys_authorities` VALUES ('delete:/v1/menu/{id}', '删除菜单', '菜单管理', 10, '2019-12-06 17:37:16');
INSERT INTO `sys_authorities` VALUES ('delete:/v1/role/{id}', '删除角色', '角色管理', 14, '2019-12-06 17:37:16');
INSERT INTO `sys_authorities` VALUES ('delete:/v1/user/{id}', '删除用户', '用户管理', 24, '2019-12-06 17:37:16');
INSERT INTO `sys_authorities` VALUES ('get:/v1/authorities', '查询所有权限', '权限管理', 1, '2019-12-06 17:37:16');
INSERT INTO `sys_authorities` VALUES ('get:/v1/file', '查询所有文件', '文件管理', 5, '2019-12-06 17:37:16');
INSERT INTO `sys_authorities` VALUES ('get:/v1/menu', '查询所有菜单', '菜单管理', 7, '2019-12-06 17:37:16');
INSERT INTO `sys_authorities` VALUES ('get:/v1/role', '查询所有角色', '角色管理', 11, '2019-12-06 17:37:16');
INSERT INTO `sys_authorities` VALUES ('get:/v1/user', '查询所有用户', '用户管理', 15, '2019-12-06 17:37:16');
INSERT INTO `sys_authorities` VALUES ('get:/v1/user/info', '获取个人信息', '个人信息', 18, '2019-12-06 17:37:16');
INSERT INTO `sys_authorities` VALUES ('get:/v1/user/menu', '获取所有菜单', '个人信息', 20, '2019-12-06 17:37:16');
INSERT INTO `sys_authorities` VALUES ('post:/v1/authorities/role', '给角色添加权限', '权限管理', 2, '2019-12-06 17:37:16');
INSERT INTO `sys_authorities` VALUES ('post:/v1/authorities/sync', '同步权限', '权限管理', 4, '2019-12-06 17:37:16');
INSERT INTO `sys_authorities` VALUES ('post:/v1/file', 'upload', '文件管理', 6, '2019-12-06 17:37:16');
INSERT INTO `sys_authorities` VALUES ('post:/v1/menu', '添加菜单', '菜单管理', 8, '2019-12-06 17:37:16');
INSERT INTO `sys_authorities` VALUES ('post:/v1/role', '添加角色', '角色管理', 12, '2019-12-06 17:37:16');
INSERT INTO `sys_authorities` VALUES ('post:/v1/user', '添加用户', '用户管理', 16, '2019-12-06 17:37:16');
INSERT INTO `sys_authorities` VALUES ('post:/v1/user/login', '用户登录', '个人信息', 19, '2019-12-06 17:37:16');
INSERT INTO `sys_authorities` VALUES ('put:/v1/menu', '修改菜单', '菜单管理', 9, '2019-12-06 17:37:16');
INSERT INTO `sys_authorities` VALUES ('put:/v1/role', '修改角色', '角色管理', 13, '2019-12-06 17:37:16');
INSERT INTO `sys_authorities` VALUES ('put:/v1/user', '修改用户', '用户管理', 17, '2019-12-06 17:37:16');
INSERT INTO `sys_authorities` VALUES ('put:/v1/user/psw', '修改自己密码', '用户管理', 21, '2019-12-06 17:37:16');
INSERT INTO `sys_authorities` VALUES ('put:/v1/user/psw/{id}', '重置密码', '用户管理', 22, '2019-12-06 17:37:16');
INSERT INTO `sys_authorities` VALUES ('put:/v1/user/state', '修改用户状态', '用户管理', 23, '2019-12-06 17:37:16');
...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES (1, -1, '系统管理', '', 'layui-icon layui-icon-set', 2, '', '2019-03-26 13:19:08', '2019-12-04 15:37:41');
...
INSERT INTO `sys_menu` VALUES (9, -1, '文件管理', '#/system/file', 'layui-icon layui-icon-file-b', 1, '', '2019-12-04 15:37:28', '2019-12-04 15:37:51');
...
) ENGINE = InnoDB AUTO_INCREMENT = 36 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '角色权限' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_role_authorities` VALUES (29, 1, 'get:/v1/file', '2019-12-06 13:34:36');
INSERT INTO `sys_role_authorities` VALUES (32, 1, 'post:/v1/file', '2019-12-06 17:37:23');
INSERT INTO `sys_role_authorities` VALUES (33, 2, 'get:/v1/file', '2019-12-11 17:03:14');
INSERT INTO `sys_role_authorities` VALUES (34, 2, 'post:/v1/file', '2019-12-11 17:03:15');
INSERT INTO `sys_role_authorities` VALUES (35, 2, 'post:/v1/user/login', '2019-12-11 17:03:31');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', '59ef6e51a2655826084254d3ae9bd346', '管理员', NULL, '男', '15636163677', NULL, 0, NULL, NULL, NULL, NULL, 0, '2018-12-19 23:30:05', '2019-12-11 17:02:33');
INSERT INTO `sys_user` VALUES (3, 'rzx', '96a8029347b3ab074c8d316e4a537178', 'rzx', NULL, '男', '12345678910', NULL, 0, NULL, NULL, NULL, NULL, 0, '2019-12-11 17:02:59', '2019-12-11 17:04:34');
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户角色' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_user_role
-- ----------------------------
INSERT INTO `sys_user_role` VALUES (2, 2, 2, '2019-03-29 13:13:35');
INSERT INTO `sys_user_role` VALUES (3, 1, 1, '2019-12-11 17:02:22');
INSERT INTO `sys_user_role` VALUES (5, 3, 1, '2019-12-11 17:04:21');
